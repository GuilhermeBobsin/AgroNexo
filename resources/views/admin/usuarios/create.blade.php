                        ...
                        <div class="card card-md">
                            <div class="card-body">
                                ...
                                <div class="form-footer">
                                    <button type="submit" id="btn-salvar-usuario" class="btn btn-primary w-100">Criar conta</button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="container-tight">
                        ...
                        <div class="form-selectgroup form-selectgroup-boxes d-flex flex-column">
                            ...
                            <label class="form-selectgroup-item flex-fill mt-2">
                                <input type="radio" name="perfil" value="operador" class="form-selectgroup-input" checked>
                                <div class="form-selectgroup-label d-flex align-items-center p-3">
                                    <span class="me-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-2">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
