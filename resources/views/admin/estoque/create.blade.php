...
<main id="content" class="page-body"><div class="container-xl">
    ...
    @if ($produtos->isEmpty() || $propriedades->isEmpty())<div class="alert alert-warning">É necessário cadastrar produtos e propriedades antes de lançar o estoque.</div>@endif
